...
void f_open_global_clim(    short stage, short yr, short mon, FILE *fp_clim[N_CLIMD]);
void f_open_bamiyan_clim(   short stage, short yr, FILE *fp_clim[N_CLIMD]);
void f_open_easia_clim(     short stage, short yr, short mon, FILE *fp_clim[N_CLIMD]);
void f_open_japan_clim(     short stage, short yr, short mon, short day, short hour, FILE *fp_clim[N_CLIMD]);
void f_open_bb_clim(        short stage, short yr, short mon, short day, short hour, FILE *fp_clim[N_CLIMD]);
void f_open_japanc_clim(    short stage, short yr, short mon, short day, short hour, FILE *fp_clim[N_CLIMD]);
void f_open_japanh_clim(    short stage, short yr, short mon, short day, short hour, FILE *fp_clim[N_CLIMD]);
