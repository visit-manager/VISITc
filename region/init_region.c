...
/* initialize CFSR global conditions ****************************/
...
void f_init_global_run(
	...
	/* elevation */
	if((fp_dat = fopen("./input/srtm_global_qd.flt","rb")) == NULL){
		printf("!! NO srtm_global_qd.flt file\n");
		exit (1);
	}
	fread(fdat, sizeof(float), WGRIDS, fp_dat);
	if(NOTICE == 1){
		printf(" Reading ./input/srtm_global_qd.flt...");
	}
	for(i=0; i<WGRIDS; i++){ 
		grid[i].topo = fdat[i];
		//grid[i].topo = 100.0;
	...
	/* land cover ********/
	if((fp_dat = fopen("./input/synmap_qd.flt","rb")) == NULL){
		printf("!! NO synmap_qd.flt data\n");
		exit (1);
	}
	fread(fdat, sizeof(float), WGRIDS, fp_dat);
	if(NOTICE == 1){
		printf(" Reading ./input/synmap_qd.flt...");
	}
	for(i=0; i<WGRIDS; i++){ 
	...
	/* crop fraction *****************************/
	if((fp_dat = fopen("./input/crop2015.flt","rb")) == NULL){
		printf("!! NO crop2015.flt data\n");
		exit (1);
	}
	fread(fdat, sizeof(float), WGRIDS, fp_dat);
	for(i=0; i<WGRIDS; i++){
	...
	if(NOTICE == 1){
		printf(" Reading ./input/crop2015.flt...");
	}
	fclose(fp_dat);
	if(NOTICE == 1){
		printf("done\n");
	...
	/* soil type *****************************/
	if((fp_dat = fopen("./input/soiltaxonomy_order_qd.flt","rb")) == NULL){
		printf("!! NO soiltaxonomy_order_qd.flt data\n");
		exit (1);
	}
	fread(fdat, sizeof(float), WGRIDS, fp_dat);
	for(i=0; i<WGRIDS; i++){
    ...
    if(NOTICE == 1){
		printf(" Reading ./input/soiltaxonomy_order_qd.flt...");
	}
	fclose(fp_dat);
	if(NOTICE == 1){
		printf("done\n");
	...
	/* clay fraction */
	if((fp_dat = fopen("./input/hwsd_soilmap_global_qd_tclay.flt","rb")) == NULL){
		printf("!! NO ./input/hwsd_soilmap_global_qd_tclay.flt data\n");
		exit (1);
	}
	fread(fdat, sizeof(float), WGRIDS, fp_dat);
	if(NOTICE==1){
		printf(" Reading ./input/hwsd_soilmap_global_qd_tclay.flt...");
	}
	for(i=0; i<WGRIDS; i++){ 
	...
	/* sand fraction */
	if((fp_dat = fopen("./input/hwsd_soilmap_global_qd_tsand.flt","rb")) == NULL){
		printf("!! NO ./input/hwsd_soilmap_global_qd_tsand.flt data\n");
		exit (1);
	}
	fread(fdat, sizeof(float), WGRIDS, fp_dat);
	if(NOTICE==1){
		printf(" Reading ./input/hwsd_soilmap_global_qd_tsand.flt...");
	}
	for(i=0; i<WGRIDS; i++){ 
	...
	for(i=0; i<WGRIDS; i++){
		...
		if(NOTICE==1){
			...
			if((i+1)%30==0) printf("%2d", grid[i].veg_type);
			if((i+1)%NCOL==0){
				printf("\n  ");
			}
		}
