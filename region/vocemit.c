...
void f_voc_emit_guenther97(
	...
	*/
	...
	if((mass->tree).day_frush <=0){
		f_phenology = 0.1;
	}else if((mass->tree).day_frush >0 && (mass->tree).day_frush <=30){
		f_phenology = 0.3;
	}else if((mass->tree).day_frush >30 && (mass->tree).day_frush <=100){
		f_phenology = 1.1;
	}else if((mass->tree).day_frush >100 && (mass->tree).day_frush <=200){
		f_phenology = 0.4;
	}else if((mass->tree).day_frush >200){
		f_phenology = 0.1;
	}
...
/*	t_lai = 0.0;
	...
	cc = foliar_dens * loct->daylen * 10000.0 / 1000000.0;
